...
fun main() {
     ...
     * **/
    val numbers = 1..100  // [1,100] arası
    val numbers2 = 1.rangeTo(100)
    //    val numbers3 = 1 rangeTo 100  ----> bu kullanım olmaz

    /* -------------------------------------------------------------------------------------------------------------------*/

    /**
     *      Char'lardan olusan bir liste de tanimalanabilir. Turkce karakterleri icermez.
     * **/
    val alphabet = 'A'..'Z'
...
/* -------------------------------------------------------------------------------------------------------------------*/
    ...
    val reversedNumbers = 100.downTo(1)   // 100den 1 e doğru gider ve ilk-son değerde dahjildir buna
...
/* -------------------------------------------------------------------------------------------------------------------*/
     ...
     * **/
    val gradeNumbers = 10.until(100) // [10,100) , 10 dahil 100 dahil değil listeye
...
/* -------------------------------------------------------------------------------------------------------------------*/
    ...
    numberList.count()
// count{} böyle yazıldığı zaman şart alır içine ve şartı sağlayan listeyi alır.50 den büyük olanların sayısını bulur
