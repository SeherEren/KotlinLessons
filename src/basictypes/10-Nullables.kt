...
fun main() {
     ...
     *      Tipin yanına Direk null yazarak nullable değer ataması yapılmaz
     ...
     *
     *      Değişken tanımlarken varsayılan olarak hep val olarak tanımlamalıyız.
     * **/

    val name: String? = null
    val age: Int? = null

    val number3 = null // Nothing?  // Tip vermeden "null" ataması yaparsak Nothing olarak atar.
    ...
    /** Best Practise göre uygulama canlıya cıkmadan önce nullable ifadeler için !! kullanın ama, canlıya çıkarken ?. kullanın,
