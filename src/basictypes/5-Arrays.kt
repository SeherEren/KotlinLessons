...
fun main() {
     ...
     *      arrayOf<Any>(farkli tip degerler) seklinde tanimlanabilir. Az kullanılsın fazla yer kaplar.
     *      arrayOfNulls<Type>(size) seklinde ise verilen boyut kadar null deger iceren dizi tanimlanabilir.Arayüzünü ve size'ını belirtmek şartıla array oluşturulur
     * **/

    val studentNumbers = arrayOf(13, 45, 54, 25, 10)
    ...
    val arrayOfNulls = arrayOfNulls<String>(4)   //belirtilen sayıda yazılan tipe göre eleman alır içerisine.
    // Değerleri bilinmeyen dizilerin içerisine kaç adet ve türünü belirterek tanımlarız.
...
/* -------------------------------------------------------------------------------------------------------------------*/
    ...
    /**
     *      ByteArray, ShortArray, IntArray, LongArray, DoubleArray, FloatArray gibi primitive array tanimlamalari da yapilabilir.
    ...
    println("firstCharOfCountrys index 2 :" + firstCharOfCountries.get(2))  // Herhangi bir array'in değerini .get yazarak ulaşabiliriz.
