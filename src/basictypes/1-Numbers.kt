...
fun main() {
    ...
    // val name :String ="SEHER EREN"

    // val name2 = "Seher Eren"
    /*val name3 :String
    name3 ="Seher" */
...
//    val octalNumber = 0197    // 8'lik sayı sistemini desteklemez. Calismaz. Comment'i kaldir kontrol et istersen keko
