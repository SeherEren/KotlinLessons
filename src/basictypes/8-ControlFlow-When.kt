...
/* -------------------------------------------------------------------------------------------------------------------*/
    ...
    // is !is ile bir class'in referansi olunup olunmadigi kontrolu yapilabilir. Verdiğimiz değişkenin tipinin verdiğimiz class olup olmadığını kontrol eder.
...
/* -------------------------------------------------------------------------------------------------------------------*/
    ...
    // range'leri in !in seklinde kontrolu yapilabilir. Range'lerin içerisinden bir değer olup olmadığına bakar " in "
    val number = 3
    when (number) {
        in 0..10 -> {
            println("Long value")
